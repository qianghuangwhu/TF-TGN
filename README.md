# TF-TGN
The codebase for TF-TGN, a temporal graph neural network (TGNN) based on the **Transformer decoder** to model the evolution of large-scale temporal graphs.
...
- Flash-attention 2 ([xformers](https://github.com/facebookresearch/xformers))
